    ...
    <div>
      <div className="relative border mt-70 md:mt-0 md:mb-0">
        ...
        <div className="flex flex-col">
          <h1 className="absolute top-40 left-0 text-7xl md:top-50 md:left-180 md:text-8xl font-bold text-orange-500">
            <div ref={refs[0]} className="fade-in-down">PALTAN</div>
          </h1>
