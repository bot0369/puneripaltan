  ...
  return (
    <div>
      ...
      >
        ...
        >
          <h1 ref={refs[0]} className="py-26 md:px-0 text-orange-600 md:text-white text-[77px] md:text-[80px] font-bold md:tracking-widest fade-in-down">
            PLAYERS
          </h1>
        </div>
        <img
          ...
          alt="Players Banner"
          ref={refs[1]}
          className="absolute bottom-35 right-5 md:w-180 md:h-115 scale-260 md:-bottom-12 md:-right-10 md:scale-90 fade-in-up"
        />
      </div>
      <div>
        <Raiders />
