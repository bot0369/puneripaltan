    ...
    <div>
      ...
      <div>
        ...
        {status === "succeeded" && galleryDetails && (
          <div>
            <h1 className="text-5xl font-bold py-10 px-20 text-orange-600 text-center">
              {galleryDetails.name}
            </h1>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 px-30 py-6 mb-20">
            ...
            <div className="flex justify-between items-center text-2xl font-semibold relative">
              {prevMatch && (
                <Link
                  to={`/getGalleryDetails/${prevMatch.id}`}
                  className="relative bg-cover w-1/2 h-80 bg-center text-white flex justify-center items-center overflow-hidden"
                  style={{
