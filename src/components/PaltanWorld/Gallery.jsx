    ...
    <div>
      ...
      >
        ...
        <div className="text-white w-full">
          <img src={img} alt="" className="absolute w-120 bottom-0" />
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-20 px-50 pb-20">
                ...
                <Link to={`/getGalleryDetails/${item.id}`}>
                  <div key={index} className="text-center">
                    ...
                    <div className="flex flex-cols py-2">
                      <div>
                        <h2
                          className="text-lg font-bold bg-orange-600 py-3 px-5 text-white text-xl font-normal italic"
                          style={{
                            clipPath:
